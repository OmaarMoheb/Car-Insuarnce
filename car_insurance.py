...
import numpy as np
import joblib
st.set_page_config(layout='wide',page_title='car_insurance')
st.image('https://forcescompare.uk/wp-content/uploads/2024/12/Car-Insurance-2-no-tint.png',width=1000)
